...
import shoppingmall.core.domain.order.dto.response.QOrderProductResponseDto;
...
import shoppingmall.core.domain.order.entity.OrderProduct;

import java.util.List;

import static shoppingmall.core.domain.order.entity.QOrder.order;
import static shoppingmall.core.domain.order.entity.QOrderProduct.orderProduct;
import static shoppingmall.core.domain.product.entity.QProduct.product;
